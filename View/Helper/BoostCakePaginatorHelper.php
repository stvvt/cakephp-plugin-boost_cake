...
class BoostCakePaginatorHelper extends PaginatorHelper {
	...
	public function prev($title = null, $options = array(), $disabledTitle = null, $disabledOptions = array()) {
		...
		return parent::prev($title, $options, $this->link($title, array(), $options), array_merge($options, array(
			'escape' => false,
			'class' => $disabled,
		)));
	}
	...
	public function next($title = null, $options = array(), $disabledTitle = null, $disabledOptions = array()) {
		...
		return parent::next($title, $options, $this->link($title, array(), $options), array_merge($options, array(
			'escape' => false,
			'class' => $disabled,
		)));
	}
